...
\def\uberschrift{Transient absorption \\[5pt] spectroscopy} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{SS 2023}
\def\datum{05.06.2023}
\def\platz{}
\def\betreuer{Rishabh Saxena}
\def\groupnr{2}

\begin{titlepage}
			
	\centering
	{\LARGE \bf \bottom} \\[3ex]	\vspace{2.5cm}
